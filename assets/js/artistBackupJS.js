...
const getArtistInfos = () => {
  fetch(artistEndPoint)
    ...
    .then((artista) => {
      ...
      mobFans.innerText = artista.nb_fan.toString().slice(-8) + "Ascoltatori mensili";
      deskFans.innerText = artista.nb_fan.toString().slice(-8) + "Ascoltatori mensili";
    })
    .catch((err) => {
      console.log(err);
    });
...
//   const getTrackList = document.createElement("div");
//   getTrackList.className = "placeholder";
